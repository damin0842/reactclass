...
function Card({ attr }) {
  return (
    ...
    >
      <h2>어린이 식물 관찰 교실</h2>
      <p>다육식물정원, 아열대정원, 무늬정원, 사막정원 등 체험하고 관찰</p>
      <div className="card__inner">
        <article className="card">
          ...
          <div className="card__body">
            <h3 className="tit">식물클리닉 교실</h3>
            <p className="desc">
              가정에서 식물 키우기와 분갈이, 병충해 관리 등의 어려움을 해소하고
              식물의 건강한 관리를 위한 유익한 전문지식을 배우는 수업입니다.
            </p>
        ...
        <article className="card">
          ...
          <div className="card__body">
            <h3 className="tit">자생식물 사진교실</h3>
            <p className="desc">
              식물과 다양한 생물을 사진으로 표현하는 강좌로 사진에 대한 이해와
              촬영 기술을 학습을 바탕으로 전시원 현장을 돌면서 실습하는
              수업입니다.
            </p>
            <a className="btn" href="/">
              더 자세히 보기
        ...
        <article className="card">
          ...
          <div className="card__body">
            <h3 className="tit">식물세밀화 교실</h3>
            <p className="desc">
              식물세밀화란 식물이 가진 특징을 정확히 관찰하고 묘사하여 기록함과
              동시에 아름다운 형태로 구성하는 과정에서 창작의 의미가 부여되는
              예술 입니다.
            </p>
            <a className="btn" href="/">
              더 자세히 보기
